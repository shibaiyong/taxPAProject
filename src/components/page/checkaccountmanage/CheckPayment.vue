...
export default {
  ...
  methods: {
    ...
    handleExport(){
      ...
      idsStr = ids.join(',')
      if(idsStr){
        window.open('http://12.3.0.15:8090/export/exportReconciliationResultList?ids='+idsStr+'&reconciliationType=2','_self')
      }else{
        window.open('http://12.3.0.15:8090/export/exportReconciliationResultList?reconciliationType=2','_self')
      }
    },
